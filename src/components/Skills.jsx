        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-gray-900 dark:text-gray-100">
          <div>
            <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-500 mb-3 flex items-center">
              <CloudIcon className="h-6 w-6 mr-2 text-primary-500 dark:text-primary-700" /> Cloud Platforms
            </h3>
          ...
          <div>
            <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-500 mb-3 flex items-center">
              <Cog6ToothIcon className="h-6 w-6 mr-2 text-primary-500 dark:text-primary-700" /> DevSecOps Tools
            </h3>
            <ul className="list-disc list-inside space-y-1 text-gray-500 dark:text-gray-300">
              <li>Terraform</li>
              <li>Ansible</li>
          ...
          <div>
            <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-500 mb-3 flex items-center">
              <CodeBracketIcon className="h-6 w-6 mr-2 text-primary-500 dark:text-primary-700" /> Programming/Scripting
            </h3>
            <ul className="list-disc list-inside space-y-1 text-gray-500 dark:text-gray-300">
              <li>Python</li>
              <li>Bash</li>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-500 mb-3 flex items-center">
              <ShieldCheckIcon className="h-6 w-6 mr-2 text-primary-500 dark:text-primary-700" /> Security Tools
            </h3>
            <ul className="list-disc list-inside space-y-1 text-gray-500 dark:text-gray-300">
          ...
          <div>
            <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-500 mb-3 flex items-center">
              <DocumentCheckIcon className="h-6 w-6 mr-2 text-primary-500 dark:text-primary-700" /> Compliance & Frameworks
            </h3>
            <ul className="list-disc list-inside space-y-1 text-gray-500 dark:text-gray-300">
              <li>ISO 27001</li>
              <li>NIST</li>
          ...
          <div>
            <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-500 mb-3 flex items-center">
              <ServerStackIcon className="h-6 w-6 mr-2 text-primary-500 dark:text-primary-700" /> Operating Systems
            </h3>
            <ul className="list-disc list-inside space-y-1 text-gray-500 dark:text-gray-300">
              <li>Linux</li>
            </ul>
