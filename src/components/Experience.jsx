  ...
  return (
    <section id="experience" className="bg-white rounded-lg shadow-lg p-8 mb-8 security-focus">
      ...
      <div className="text-gray-900">
        <div className="timeline-item mb-8 p-6 bg-gray-50 rounded-lg shadow-md">
          <h3 className="font-bold text-2xl text-primary-700">Siaras Research Inc.</h3>
          <p className="text-secondary-500 text-lg">Software Engineer | May 2016 - Jan 2017</p>
          <ul className="list-disc list-inside mt-4 space-y-1 text-left mx-auto max-w-xl text-gray-500">
            <li>Developed and maintained software solutions for research projects.</li>
          </ul>
        </div>
        <div className="timeline-item mb-8 p-6 bg-gray-50 rounded-lg shadow-md">
          <h3 className="font-bold text-2xl text-primary-700">Sandvine</h3>
          <p className="text-secondary-500 text-lg">Software Engineer - Virtualization | March 2017 - Feb 2018</p>
          <ul className="list-disc list-inside mt-4 space-y-1 text-left mx-auto max-w-xl text-gray-500">
