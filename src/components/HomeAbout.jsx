      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8 mx-auto max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 rounded-lg certificate-badge bg-primary-50 dark:bg-gray-700 transform hover:scale-105 transition-transform duration-300">
            <CloudIcon className="mx-auto h-6 w-6 md:h-5 md:w-5 lg:h-4 lg:w-4 text-primary-500 dark:text-primary-300 mb-2" /> {/* AWS Icon */}
          ...
          <div className="text-center p-4 rounded-lg certificate-badge bg-primary-50 dark:bg-gray-700 transform hover:scale-105 transition-transform duration-300">
            <ShieldCheckIcon className="mx-auto h-6 w-6 md:h-5 md:w-5 lg:h-4 lg:w-4 text-primary-500 dark:text-primary-300 mb-2" /> {/* CISSP Icon */}
          ...
          <div className="text-center p-4 rounded-lg certificate-badge bg-primary-50 dark:bg-gray-700 transform hover:scale-105 transition-transform duration-300">
            <CubeIcon className="mx-auto h-6 w-6 md:h-5 md:w-5 lg:h-4 lg:w-4 text-primary-500 dark:text-primary-300 mb-2" /> {/* Kubernetes Icon */}
