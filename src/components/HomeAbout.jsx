      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8 mx-auto max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 rounded-lg certificate-badge bg-primary-50 dark:bg-gray-700 transform hover:scale-105 transition-transform duration-300">
            <CloudIcon className="mx-auto h-12 w-12 text-primary-500 dark:text-primary-300 mb-3" /> {/* AWS Icon */}
          ...
          <div className="text-center p-4 rounded-lg certificate-badge bg-primary-50 dark:bg-gray-700 transform hover:scale-105 transition-transform duration-300">
            <ShieldCheckIcon className="mx-auto h-12 w-12 text-primary-500 dark:text-primary-300 mb-3" /> {/* CISSP Icon */}
          ...
          <div className="text-center p-4 rounded-lg certificate-badge bg-primary-50 dark:bg-gray-700 transform hover:scale-105 transition-transform duration-300">
            <CubeIcon className="mx-auto h-12 w-12 text-primary-500 dark:text-primary-300 mb-3" /> {/* Kubernetes Icon */}
